        ...
        <>
            <Offcanvas show={show} onHide={handleClose} placement="start" backdrop={false} scroll={true} >
                <Offcanvas.Body className='ps-0 pe-2'>
                    ...
                    <div id="Article" className='select-page'>
                        <Dropdown.Toggle onClick={() => handlePath('/Article')} className={asPath === "/Article" || asPath === "/Article/ArticleClinic" || asPath === "/Article/ArticlePersonnel" || asPath === "/Article/ArticlePersonnel/add" ? "nav-item nav-link active" : "nav-item nav-link"} id="dropdown-custom-components" >
                            <i >
                                <FaTachometerAlt />
                            </i>
                        ...
                        <Dropdown.Menu className="bg-transparent border-0" show={checkClickPath === "/Article" || checkClickPath === "/Article/ArticleClinic" || checkClickPath === "/Article/ArticlePersonnel" || asPath === "/Article/ArticlePersonnel/add"} >
                            <Link href="/Article/ArticleClinic" className={asPath === "/Article" || asPath === "/Article/ArticleClinic" ? "nav-link active" : "nav-link"}>
                                <span>ArticleClinic</span>
                            </Link>
                            <Link href="/Article/ArticlePersonnel" className={asPath === "/Article/ArticlePersonnel" || asPath === "/Article/ArticlePersonnel/add" ? "nav-link active" : "nav-link"}>
                                <span>ArticlePersonnel</span>
                            </Link>
                        </Dropdown.Menu>
                    ...
                    <Dropdown.Toggle onClick={() => handlePath('/Article')} className={asPath === "/Article" || asPath === "/Article/ArticleClinic" || asPath === "/Article/Article" || asPath === "/Article/Article/add" ? "nav-item nav-link active" : "nav-item nav-link"} id="dropdown-custom-components" >
                            <i >
                                <FaTachometerAlt />
                            </i>
                            <span className="ms-2">Article</span>
